...
public static class InputHelper
{
    ...
    {
        return PersistInput(day, false, GetResponse("https://adventofcode.com/2021/day/{0}/input", day)).Split("\n");
    }
    public static string[] GetSampleInput(int day)
    {
        return PersistInput(day, true, GetCodeSnippetFromHtml(GetResponse("https://adventofcode.com/2021/day/{0}", day))).Split("\n");
    }
